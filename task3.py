...
f.write("<text x=\"70\" y=\"15\" fill=\"red\">"+sym+"Exchange rates (Base EUR) Current rate "+str(rr[sym])+"</text>\n")
...
f.write('''<svg width="1000" height="1000" xmlns="http://www.w3.org/2000/svg">\n''')
f.write('''<rect width="100%" height="100%" fill="white" />\n''')
f.write("<text x=\"70\" y=\"15\" fill=\"red\">"+sym2+"Exchange rates (Base EUR)Current rate "+str(rr[sym2])+"</text>\n")
